...
public class Wolf extends Enemy {
    ...
    public Wolf(int x, int y) {
        ...
        if (Wolf.image_left == null) {
            Wolf.image_left = new ImageIcon("cmpt276Group9ImplementationMaven/src/main/resources/images/48_wolf_left.gif").getImage();
            Wolf.image_right = new ImageIcon("cmpt276Group9ImplementationMaven/src/main/resources/images/48_wolf_right.gif").getImage();
        }
    }
